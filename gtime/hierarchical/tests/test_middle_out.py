...
def hierarchical_basic_middle_out_model(time_series_forecasting_model1_no_cache):
    return HierarchicalMiddleOut(time_series_forecasting_model1_no_cache, 'infer')

@fixture(scope="function")
def hierarchical_basic_middle_out_model_fp_method(time_series_forecasting_model1_no_cache):
    return HierarchicalMiddleOut(time_series_forecasting_model1_no_cache, hierarchy_tree='infer', method='tdfp')

@st.composite
def hierarchical_middle_out_model_sga(draw, time_series_forecasting_model1_no_cache):
    dataframes = draw(n_time_series_with_same_index(min_n=5))
    tree = draw(tree_construction(dataframes))
    method = 'tdsga'
    return HierarchicalMiddleOut(model=time_series_forecasting_model1_no_cache, hierarchy_tree=tree, method=method)

@st.composite
def hierarchical_middle_out_model_sga_level0(draw, time_series_forecasting_model1_no_cache):
    dataframes = draw(n_time_series_with_same_index(min_n=5))
    tree = draw(tree_construction(dataframes))
    method = 'tdsga'
    return HierarchicalMiddleOut(model=time_series_forecasting_model1_no_cache, hierarchy_tree=tree, method=method, level=0)


@st.composite
def hierarchical_middle_out_model_sgf(draw, time_series_forecasting_model1_no_cache):
    dataframes = draw(n_time_series_with_same_index(min_n=5))
    tree = draw(tree_construction(dataframes))
    method = 'tdsgf'
    return HierarchicalMiddleOut(model=time_series_forecasting_model1_no_cache, hierarchy_tree=tree, method=method)
...
@st.composite
def hierarchical_middle_out_model_fp(draw, time_series_forecasting_model1_no_cache):
    dataframes = draw(n_time_series_with_same_index(min_n=5))
    tree = draw(tree_construction(dataframes))
    method = 'tdfp'
    return HierarchicalMiddleOut(model=time_series_forecasting_model1_no_cache, hierarchy_tree=tree, method=method)
...
@st.composite
def hierarchical_middle_out_model_sga_tree_by_hand(draw, time_series_forecasting_model1_no_cache):
    tree_adjacency_list = {'0': {}, '1': {}, '2': {'1': {}, '4': {}}, '3': {'0': {}, '2': {}}, '4': {}}
    tree = nx.DiGraph(tree_adjacency_list)
    root = '3'
    return HierarchicalMiddleOut(model=time_series_forecasting_model1_no_cache, hierarchy_tree=tree, root=root)


@st.composite
def hierarchical_middle_out_model_sgf_tree_by_hand(draw, time_series_forecasting_model1_no_cache):
    tree_adjacency_list = {'0': {}, '1': {}, '2': {'1': {}, '3': {}}, '4': {'0': {}, '2': {}}, '3': {}}
    tree = nx.DiGraph(tree_adjacency_list)
    root = '4'
    return HierarchicalMiddleOut(model=time_series_forecasting_model1_no_cache, method='tdsgf', hierarchy_tree=tree, root=root)

@st.composite
def hierarchical_middle_out_model_fp_tree_by_hand(draw, time_series_forecasting_model1_no_cache):
    tree_adjacency_list = {'0': {}, '1': {}, '2': {'1': {}, '3': {}}, '4': {'0': {}, '2': {}}, '3': {}}
    tree = nx.DiGraph(tree_adjacency_list)
    root = '4'
    return HierarchicalMiddleOut(model=time_series_forecasting_model1_no_cache, method='tdfp', hierarchy_tree=tree, root=root)
