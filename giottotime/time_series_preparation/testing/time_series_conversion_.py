...
class TestSequenceToPandasTimeSeries:
    ...
    def _pandas_series_with_timedelta_index(
        self, values: Iterable, length: int, start_date: str, end_date: str, freq: str,
    ):
        index = pd.timedelta_range(
            start=start_date, end=end_date, periods=length, freq=freq
        )
