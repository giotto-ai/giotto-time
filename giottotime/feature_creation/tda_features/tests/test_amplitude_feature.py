...
def test_correct_amplitude_computation():
    ...
    amplitudes = amplitude_feature. \
        _calculate_amplitude_feature(persistence_diagrams)

    expected_amplitudes = np.array([[0.42390011], [0.42392732], [0.48618924],
                                    [0.46564008], [0.46508716], [0.33761475],
                                    [0.33761475], [0.33680451], [0.29547906],
                                    [0.30680885], [0.29692516], [0.29494336],
                                    [0.35830464], [0.35827269], [0.35806485],
                                    [0.37202706], [0.3731072]])
...
def test_correct_amplitude_feature():
    ...
    expected_amplitudes = pd.DataFrame.from_dict(
        {output_name: [0.423900, 0.423900, 0.423927, 0.423927, 0.486189,
                       0.486189, 0.465640, 0.465640, 0.465087, 0.465087,
                       0.337615, 0.337615, 0.337615, 0.337615, 0.336805,
                       0.336805, 0.295479, 0.295479, 0.306809, 0.306809,
                       0.296925, 0.296925, 0.294943, 0.294943, 0.358305,
                       0.358305, 0.358273, 0.358065, 0.372027, 0.373107
                       ]
         })
