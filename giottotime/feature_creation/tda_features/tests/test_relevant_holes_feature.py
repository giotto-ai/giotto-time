...
from giottotime.feature_creation.tda_features import \
...
def test_correct_n_holes_feature():
    ...
    theta = 0.4
    output_name = 'n_holes'
    n_holes_feature = NumberOfRelevantHolesFeature(output_name=output_name,
                                                   h_dim=h_dim,
                                                   theta=theta)
    ...
    expected_n_holes = pd.DataFrame.from_dict(
        {output_name: [9., 9., 10., 10., 9., 9., 10., 10., 10., 10., 10., 10.,
